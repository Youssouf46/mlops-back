...
with st.form("form1",clear_on_submit=False):
    ...
    res = requests.post("https://backendapiahmed.herokuapp.com/predict", data=json.dumps(dd))
    # res = requests.post("http://lb-backendapp-1500115353.us-east-1.elb.amazonaws.com/predict", data=json.dumps(dd))
